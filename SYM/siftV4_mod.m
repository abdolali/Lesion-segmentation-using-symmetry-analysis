% [image, descriptors, locs] = sift(image)
%
...
function [image, descriptors, locs] = siftV4_mod(image)

% if filename passed then load image 
if min(size(image))==1
    image = imread(image);
end
...
if isunix
    ...
    command = '!C:\Users\meisam\Documents\MATLAB\SYM\siftWin32 ';
end
